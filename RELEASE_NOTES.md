Codex Vault 0.2.4 adds a downloadable Linux x86_64 package alongside Windows.
...
- Unix snapshots, journals, summaries, scratch files and indices are created with private permissions. New vault directories use mode `0700`; sensitive files use `0600`. Compact and restore preserve the transcript's Unix owner, group and permission bits.
