...
This intentionally **does not** implement hibernation, summaries-as-memory, SQLite FTS or MCP yet. Those belong in v0.2 after the destructive core is validated against real sessions.
